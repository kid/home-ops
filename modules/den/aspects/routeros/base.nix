  ...
  den.aspects.routeros.base = {
    "terragrunt-stacks" =
      ...
      let
        ...
        # every group materialized as a RouterOS resource (a device
        # with no user in a group shouldn't get that group either) — only
        # emit the groups actually referenced on this device.
