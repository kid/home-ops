# Typed nixidy resource options for cert-manager's ClusterIssuer/Certificate
# CRDs (kindFilter = [ "Certificate" "ClusterIssuer" ]), generated from
# charts.jetstack.cert-manager via nixidy's generators.fromChartCRD. Used by
# modules/kubernetes/cert-manager/default.nix's nixidy.applicationImports.
# Regenerate with:
#   nix build --impure --expr '(builtins.getFlake "git+file://'"$PWD"'").inputs.nixidy.packages.x86_64-linux.generators.fromChartCRD { name = "cert-manager"; chart = (builtins.getFlake "git+file://'"$PWD"'").chartsDerivations.x86_64-linux.jetstack.cert-manager; kindFilter = [ "Certificate" "ClusterIssuer" ]; }' -o modules/kubernetes/cert-manager/_crds.nix
# This file was generated with nixidy resource generator, do not edit further.
{
  lib,
  options,
  config,
    ...
    "cert-manager.io.v1.CertificateSpecRenewal" = {
      ...
      options = {
        ...
        "windows" = mkOption {
          ...
          type = types.nullOr (types.listOf (submoduleOf "cert-manager.io.v1.CertificateSpecRenewalWindows"));
        };
      };
    ...
    "cert-manager.io.v1.ClusterIssuerSpecVaultAuthAws" = {
      ...
      options = {
        ...
        "serviceAccountRef" = mkOption {
          ...
          type = types.nullOr (
            submoduleOf "cert-manager.io.v1.ClusterIssuerSpecVaultAuthAwsServiceAccountRef"
          );
        };
